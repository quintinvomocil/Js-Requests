...
const changeSayHelloButton = () => {
    
    let styleBtn = document.getElementById('say-hello-button')
    styleBtn.style.backgroundColor = "black"
...
const repeatMyParam = () => {
     return axios.get('http://localhost:3000/repeat/I-Love-Sex')
     .then(res => {
...
/*
    ...
    The key should be newFood (make sure to match the case and spelling exactly) and 
    the value should be the value of the food input. 
